...
R se chama `mutate()` ("modificar"). Ela é extremamtente útil, pois permite
...
Perceba que o comando acima returnou uma nova tabela com uma linha só, mas
...
O mais comum, no entando, é agrupar a tabela por uma ou mais colnas e somente
...
valores correspondentes daquelas variáveis antes de serem tomabadas (note
