...
O primeiro passo de todos é instalar o R e o RStudio. O que
...
se você tiver escrito alguma algo errado e salvar os gráficos que você
gerar. A inferface do RStudio também é extremamente amigável, permitindo que
não programadores consigam se ambientar com facilidade.
...
Para instalar o R, primeiramente você precisa baixar o programa.
...
ficar procurando essa pasta toda vez. Só é importante lembrar que você *não* poderá
deletar a pasta **RStudio-X.X.X** porque o RStudio vai depender dela para funcionar.
...
já prontos que você pode usar para facilitar a sua vida; assim você não
...
O `tidyverse` será explicado mais para frente, então não se preocupe se você
não souber o que ele é.
...
[https://material.curso-r.com/](https://material.curso-r.com/). Último acesso
em 26/09/2018.
